...
let evenNumbers = mixedNumbers.filter(value => {
  // let evenNum =  ;
  // console.log
  return value % 2 === 0;
}) 
...
let myStrongest = monstersInYourPocket.filter(pokeMon => {
  return pokeMon.CP > 200 ;
})
...
/*
  ...
  Your answer should be an array of numbers, 
...
*/
// let bobsOrders = purchases.filter(function (el, i, arr) {
//   return el.owner === 'Bob'
// } )
...
// let bobsTotal = bobsOrders.reduce( function(acc, el, i, arr) {
//   return acc + el.price
// }
// );
// console.log('total', bobsTotal);

const bobsTotal = purchases.reduce((acc, currVal) => {
  return currVal.owner === 'Bob' ? acc + currVal.price : acc
}, 0)

console.log('Boo', bobsTotal)
